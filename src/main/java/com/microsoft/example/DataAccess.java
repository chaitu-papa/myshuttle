...
public class DataAccess
{
	...
	private static final String DB_URL = "jdbc:mysql://17.0.0.222:3306/alm";
	...
	static {
		try {
			...
			if (conStr == null || conStr.trim().length() == 0) {
				theConnection = DriverManager.getConnection("jdbc:mysql://34.196.120.121:3306/alm", "root", "mypassword");
			} else {
